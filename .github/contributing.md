# Contributing to Cricut_Voron_Logos

Thanks for your interest in contributing to Cricut_Voron_Logos!

The following is a set of guidelines for contributing to Cricut_Voron_Logos, hosted by the [GadgetAngel](https://github.com/GadgetAngel) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a Pull Request.
...
Voron has a Discord Channel and a Facebook group where our knowledgable user community can provide helpful advice if you have questions.

* [Voron Discord Channel](https://discord.com/invite/voron)
* [Voron on Facebook](https://www.facebook.com/groups/voroncorexy/)

If chat is more your speed, you can join the Voron Discord server:

* Use the link https://discord.com/invite/voron to join up as a General User.
* Even though our Discord is pretty active, it may take a while for community members to respond &mdash; please be patient!
* Use the `#gchat` channel for general questions or discussion about Voron.
...
This section guides you through submitting a Bug Report for Cricut_Voron_Logos. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior, and find related reports.
...
This section guides you through submitting a suggestion for Cricut_Voron_Logos, including completely new features. Following these guidelines helps maintainers and the community understand your suggestion and find related suggestions.
